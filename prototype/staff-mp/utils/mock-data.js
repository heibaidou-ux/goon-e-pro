/**
 * 高岸ERP 店员端 Mock 数据
 * 复用与客人端一致的数据格局，添加店员端特有数据
 */

// ── 门店 ──
const stores = [{ storeId: "ST001", name: "盈隆店", address: "广州珠江新城盈隆广场", phone: "020-88888888", status: "Active" }]

// ── 房间 ──
const rooms = [
  { roomId: "RM001", name: "大会议室", type: "MeetingRoom", capacity: 10, area: 30, facilities: ["投影","会议桌","K歌设备","落地窗"], pricePerHour: 200, pricePerHalfHour: 120, status: "Active", bookable: true },
  { roomId: "RM002", name: "中茶室A", type: "TeaRoom", capacity: 4, area: 18, facilities: ["茶台","落地窗","茶具套装"], pricePerHour: 80, pricePerHalfHour: 50, status: "Active", bookable: true },
  { roomId: "RM003", name: "中茶室B", type: "TeaRoom", capacity: 4, area: 18, facilities: ["茶台","落地窗","茶具套装"], pricePerHour: 80, pricePerHalfHour: 50, status: "Active", bookable: true },
  { roomId: "RM004", name: "大茶室C", type: "TeaRoom", capacity: 6, area: 25, facilities: ["茶台","K歌","投影","落地窗"], pricePerHour: 120, pricePerHalfHour: 75, status: "Active", bookable: true },
  { roomId: "RM005", name: "展厅", type: "Exhibition", capacity: 20, area: 40, facilities: ["前台","收银","茶具展示","休闲区"], status: "Active", bookable: false },
  { roomId: "RM006", name: "工作间", type: "Workspace", capacity: 2, area: 12, facilities: ["储物","机柜"], status: "Active", bookable: false }
]
...
const orders = [
  { orderId:"ORD001", customerName:"张先生", roomId:"RM004", roomName:"大茶室C", status:"InUse", start:"2026-06-06T10:00:00", end:"2026-06-06T11:30:00", duration:90, amount:180, paymentMethod:"WeChat", phone:"138****8888" },
  { orderId:"ORD002", customerName:"李女士", roomId:"RM002", roomName:"中茶室A", status:"Booked", start:"2026-06-06T14:00:00", end:"2026-06-06T16:00:00", duration:120, amount:160, paymentMethod:"Balance", phone:"139****6666" },
  { orderId:"ORD003", customerName:"王先生", roomId:"RM003", roomName:"中茶室B", status:"Completed", start:"2026-06-06T08:00:00", end:"2026-06-06T09:30:00", duration:90, amount:120, paymentMethod:"WeChat", phone:"137****5555" },
  { orderId:"ORD004", customerName:"赵总", roomId:"RM001", roomName:"大会议室", status:"Completed", start:"2026-06-05T15:00:00", end:"2026-06-05T17:00:00", duration:120, amount:400, paymentMethod:"Alipay", phone:"136****7777" }
]

const scenes = [
  { sceneId:"SC001", name:"迎宾模式", icon:"👋", color:"#07c160", params:{ curtain:"open", lights:{ on:true, brightness:90, colorTemp:4000 }, ac:{ on:true, temp:24 }, music:{ on:true, track:"bgm_welcome" }}},
  { sceneId:"SC002", name:"茶艺模式", icon:"🍵", color:"#e37318", params:{ curtain:"open", lights:{ on:true, brightness:70, colorTemp:3000 }, ac:{ on:true, temp:26 }, music:{ on:true, track:"bgm_tea" }}},
  { sceneId:"SC003", name:"会议模式", icon:"💼", color:"#0052d9", params:{ curtain:"closed", lights:{ on:true, brightness:100, colorTemp:5000 }, ac:{ on:true, temp:22 }}},
  { sceneId:"SC004", name:"娱乐模式", icon:"🎤", color:"#9c27b0", params:{ curtain:"closed", lights:{ on:true, brightness:60, colorTemp:2500 }, ac:{ on:true, temp:24 }, music:{ on:true, track:"bgm_karaoke" }}},
  { sceneId:"SC005", name:"节能模式", icon:"💚", color:"#607d8b", params:{ curtain:"closed", lights:{ on:false, brightness:0 }, ac:{ on:false }}},
  { sceneId:"SC006", name:"营业前准备", icon:"🔧", color:"#ff5722", params:{ curtain:"open", lights:{ on:true, brightness:100, colorTemp:5000 }, ac:{ on:true, temp:24 }, music:{ on:true, track:"bgm_preopen" }}}
]

const products = [
  { productId:"T001", name:"安吉白茶", category:"Tea", price:68, desc:"清香甘甜，明前采摘" },
  { productId:"T002", name:"正山小种", category:"Tea", price:88, desc:"松烟香，桂圆味" },
  { productId:"T003", name:"铁观音", category:"Tea", price:58, desc:"七泡有余香" },
  { productId:"T004", name:"手工茶点A", category:"Snack", price:38, desc:"绿豆糕拼盘" },
  { productId:"T005", name:"手工茶点B", category:"Snack", price:48, desc:"坚果四宫格" },
  { productId:"T006", name:"时令水果盘", category:"Snack", price:58, desc:"当日新鲜水果" },
  { productId:"T007", name:"定制茶具A", category:"Ware", price:288, desc:"手作紫砂壶套装" },
  { productId:"T008", name:"定制茶具B", category:"Ware", price:188, desc:"玻璃茶道六君子" }
]

module.exports = { stores, rooms, devices, deviceTypes, orders, scenes, products }
